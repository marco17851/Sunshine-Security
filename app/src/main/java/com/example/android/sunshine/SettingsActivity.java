 ...
 * <p>
 * For example, when the user is in the ShowDetailsActivity and clicks the settings option in the menu,
 * and then clicks the up button, we want to navigate back to the ShowDetailsActivity. If the user
